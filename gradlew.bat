...
<root>
  <item name="android.hardware.ConsumerIrManager">
    <annotation name="android.support.annotation.SystemService">
      <val name="value" val="android.content.Context.CONSUMER_IR_SERVICE" />
    </annotation>
    <annotation name="android.support.annotation.RequiresFeature">
      <val name="value" val="&quot;android.hardware.consumerir&quot;" />
    </annotation>
  </item>
  ...
  <item name="android.hardware.HardwareBuffer android.hardware.HardwareBuffer create(int, int, int, int, long)">
    <annotation name="android.support.annotation.NonNull" />
  </item>
  <item name="android.hardware.HardwareBuff